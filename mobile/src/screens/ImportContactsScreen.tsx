...
type ImportContactsScreenNavigationProp = StackNavigationProp<ContactsStackParamList, 'ImportContacts'>;
...
const ImportContactsScreen: React.FC = () => {
  const navigation = useNavigation<ImportContactsScreenNavigationProp>();
