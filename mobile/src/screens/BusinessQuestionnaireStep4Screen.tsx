...
const BusinessQuestionnaireStep4Screen: React.FC<Props> = ({ navigation }) => {
    const { data, updateData } = useQuestionnaire();
    const [customerChallenges, setCustomerChallenges] = useState(data.challenges);

    const isFormValid = useMemo(() => customerChallenges.trim().length > 0, [customerChallenges]);
    ...
    const totalSteps = 6;
    const currentStep = 4; // change this number for each screen
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            ...
            <ScrollView style={styles.container} contentContainerStyle={styles.content}>
                ...
                {/* Customer Challenges Input */}
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Customer Problems & Pain Points</Text>

                    <Text style={styles.label}>
                        Main Customer Challenges <Text style={styles.required}>*</Text>
                    </Text>
                    <TextInput
...
export default BusinessQuestionnaireStep4Screen;
