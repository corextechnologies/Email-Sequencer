 ...
 */
export function ensureHtmlFormatting(text: string): string {
 ...
 */
export function wrapInEmailTemplate(htmlBody: string, options?: {
 ...
 */
export function formatEmailForSending(rawBody: string, options?: {
