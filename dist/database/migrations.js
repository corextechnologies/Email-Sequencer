...
class Migrations {
    ...
    static async createEmailAccountsTable() {
        const query = `
     ...
     */
    static async createCampaignsModule() {
        const query = `
		-- ===== campaigns =====
     ...
     */
    static async createPersonasTable() {
        const query = `
    ...
    static async createEnrichedDataTable() {
        const query = `
    ...
    static async createCampaignEmailsTable() {
        const query = `
     ...
     */
    static async addSequenceProgressFields() {
        const query = `
     ...
     */
    static async addSequenceStartedAt() {
        const query = `
     ...
     */
    static async addEmailOpensTracking() {
        const query = `
     ...
     */
    static async addPasswordResetFields() {
        const query = `
     ...
     */
    static async addEmailVerificationFields() {
        const query = `
