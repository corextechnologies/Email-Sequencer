...
class AuthController {
    ...
    static async forgotPassword(req, res, next) {
        try {
            // Validate request body
            const { error, value } = validation_1.userValidation.forgotPassword.validate(req.body);
            if (error) {
                res.status(400).json({
                    success: false,
                    error: {
    ...
    static async resetPassword(req, res, next) {
        try {
            // Validate request body
            const { error, value } = validation_1.userValidation.resetPassword.validate(req.body);
            if (error) {
                res.status(400).json({
                    success: false,
                    error: {
            ...
            await authService_1.AuthService.resetPassword(value.token, value.password);
            res.status(200).json({
                success: true,
    ...
    static async sendRegistrationOTP(req, res, next) {
        try {
            // Validate request body
            const { error, value } = validation_1.userValidation.sendRegistrationOTP.validate(req.body);
            if (error) {
                res.status(400).json({
                    success: false,
                    error: {
            ...
            await authService_1.AuthService.sendRegistrationOTP(value.email, value.password);
            // Always return success to prevent email enumeration
            res.status(200).json({
                success: true,
    ...
    static async verifyRegistrationOTP(req, res, next) {
        try {
            // Validate request body
            const { error, value } = validation_1.userValidation.verifyRegistrationOTP.validate(req.body);
            if (error) {
                res.status(400).json({
                    success: false,
                    error: {
            ...
            const result = await authService_1.AuthService.verifyRegistrationOTP(value.email, value.code);
            res.status(200).json({
                success: true,
                data: result,
    ...
    static async resendRegistrationOTP(req, res, next) {
        try {
            // Validate request body
            const { error, value } = validation_1.userValidation.resendRegistrationOTP.validate(req.body);
            if (error) {
                res.status(400).json({
                    success: false,
                    error: {
            ...
            await authService_1.AuthService.resendRegistrationOTP(value.email);
            res.status(200).json({
                success: true,
