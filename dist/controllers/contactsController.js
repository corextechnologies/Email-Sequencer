...
exports.uploadVCF = exports.upload = exports.ContactsController = void 0;
...
const uploadVCF = (0, multer_1.default)({
    storage: multer_1.default.memoryStorage(),
    limits: {
        fileSize: 5 * 1024 * 1024, // 5MB limit
    },
...
exports.uploadVCF = uploadVCF;
class ContactsController {
    constructor(db) {
        this.contactsService = new contactsService_1.ContactsService(db);
    }
    ...
    async importPhoneContacts(req, res) {
        try {
