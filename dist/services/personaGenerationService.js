...
exports.PersonaGenerationService = void 0;
...
class PersonaGenerationService {
     ...
     */
    static async generatePersonasFromQuestionnaire(userId, provider, apiKey, questionnaireData, options) {
        try {
            console.log(`Starting persona generation for ${questionnaireData.companyName}`);
            // Get the AI prompt for persona generation
            const prompt = this.createPersonaGenerationPrompt(questionnaireData, options);
            // Call AI service
     ...
     */
    static createPersonaGenerationPrompt(questionnaireData, options) {
...
- Overall engagement through proper timing and frequency`;
     ...
     */
    static parseAIResponseToPersonas(aiResponse, industry) {
        const personas = [];
        try {
            ...
            for (const personaJson of personasArray) {
                ...
                const extractSingleValue = (value, defaultValue) => {
     ...
     */
    static createDefaultPersona(industry) {
        return {
     ...
     */
    static async insertPersonaToDatabase(userId, persona) {
        const query = `
...
exports.PersonaGenerationService = PersonaGenerationService;
//# sourceMappingURL=personaGenerationService.js.map